		...
		<div class="inner">
			...
			<nav id="nav">
				<a href="<c:url value="/"/>">Home</a> <a
					...
					href="<c:url value="/signup/"/>">Registrieren</a>
			</nav>
		...
		<div class="inner">
			<div class="flex flex-3">
				<article>
					<header>
						<h3>
							Wer sind wir?!<br /> aliquam veroeros
						</h3>
					</header>
				...
				<article>
					<header>
						<h3>
							Was machen wir?!<br /> adipiscing vitae
						</h3>
					</header>
					<p>Morbi interdum mollis sapien. Sed ac risus. Phasellus
						lacinia, magna a ullamcorper laoreet, lectus arcu.</p>
				...
				<article>
					<header>
						<h3>
							Warum sollstest du dich uns anschliessen?<br /> sed ullamcorper
						</h3>
					</header>
					<p>Morbi interdum mollis sapien. Sed ac risus. Phasellus
						lacinia, magna a ullamcorper laoreet, lectus arcu.</p>
